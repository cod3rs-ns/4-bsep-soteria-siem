(function () {
    ...
    LoginController.$inject = ['$scope', 'loginService', '$log', '$state', '$http', '$localStorage', 'jwtHelper', 'CONFIG', '_'];

    function LoginController($scope, loginService, $log, $state, $http, $localStorage, jwtHelper, CONFIG, _) {
        var loginVm = this;
